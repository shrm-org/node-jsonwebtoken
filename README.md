...
Forked to support non-standard algorithms for JWT's generated by Microsoft's JwtSecurityTokenHandler.

From their [docs](https://msdn.microsoft.com/en-us/library/system.identitymodel.tokens.jwtsecuritytokenhandler.inboundalgorithmmap\(v=vs.114\).aspx):
